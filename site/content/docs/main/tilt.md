...
**use_node_agent** (Bool, default=false): Indicate whether to deploy the velero-node-agent Daemonset. If set to `true`, Tilt will look for a `velero/tilt-resources/velero-node-agent.yaml`  file
