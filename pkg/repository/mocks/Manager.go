...
func (_m *Manager) PruneRepo(repo *v1.BackupRepository) (string, error) {
	ret := _m.Called(repo)
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(*v1.BackupRepository) (string, error)); ok {
		return rf(repo)
	}
	if rf, ok := ret.Get(0).(func(*v1.BackupRepository) string); ok {
		r0 = rf(repo)
	} else {
		r0 = ret.Get(0).(string)
	}
