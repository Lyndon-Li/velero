...
func (_m *Manager) ClientSideCacheLimit(repoType string, repoConfig map[string]string) (int64, error) {
...
func (_m *Manager) DefaultMaintenanceFrequency(repoType string, repoConfig map[string]string) (time.Duration, error) {
	ret := _m.Called(repoType, repoConfig)
