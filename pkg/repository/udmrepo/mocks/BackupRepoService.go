...
func (_m *BackupRepoService) Maintain(ctx context.Context, repoOption udmrepo.RepoOptions) (string, error) {
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, udmrepo.RepoOptions) (string, error)); ok {
		return rf(ctx, repoOption)
	}
	if rf, ok := ret.Get(0).(func(context.Context, udmrepo.RepoOptions) string); ok {
