...
func (f *fakeDataUploadFSBR) StartBackup(source datapath.AccessPoint, realSource string, parentSnapshot string, forceFull bool, userSnapshotID string, tags map[string]string) error {
	du := f.du
