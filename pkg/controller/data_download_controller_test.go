...
func initDataDownloadReconcilerWithError(objects []runtime.Object, needError ...error) (*DataDownloadReconciler, error) {
	...
	return NewDataDownloadReconciler(fakeClient, nil, fakeKubeClient, dataPathMgr, nil, nodeagent.LoadConcurrency{}, nodeagent.RestorePVC{}, corev1api.ResourceRequirements{}, "test-node", time.Minute*5, velerotest.NewLogger(), metrics.NewServerMetrics()), nil
}
