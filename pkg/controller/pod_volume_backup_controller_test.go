...
func (b *fakeFSBR) StartBackup(uploaderConfigs map[string]string, param interface{}) error {
	pvb := b.pvb
...
func (b *fakeFSBR) StartRestore(snapshotID string, uploaderConfigs map[string]string) error {
	return nil
}
