...
// DefaultToPodVolumes sets the Backup's "DefaultToPodVolumes" flag.
func (b *BackupBuilder) DefaultToPodVolumes(val bool) *BackupBuilder {
	b.object.Spec.DefaultToPodVolumes = &val
	return b
}
