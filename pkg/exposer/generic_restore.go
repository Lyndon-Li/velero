...
func (e *genericRestoreExposer) Expose(ctx context.Context, ownerObject corev1.ObjectReference, param interface{}) error {
	...
	restorePod, err := e.createRestorePod(ctx, ownerObject, targetPVC, restoreExposeParam.OperationTimeout, restoreExposeParam.HostingPodLabels, selectedNode, restoreExposeParam.Resources)
	if err != nil {
