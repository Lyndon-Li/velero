...
func (_m *GenericRestoreExposer) Expose(_a0 context.Context, _a1 v1.ObjectReference, _a2 interface{}) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, v1.ObjectReference, interface{}) error); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Error(0)
	}
