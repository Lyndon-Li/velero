...
func newMicroServiceBR(client client.Client, kubeClient kubernetes.Interface, mgr manager.Manager, namespace string, taskType string, taskName string, callbacks Callbacks, log logrus.FieldLogger) AsyncBR {
	ms := &microServiceBR{
		mgr:        mgr,
		client:     client,
