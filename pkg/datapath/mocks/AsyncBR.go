...
// StartBackup provides a mock function with given fields: dataMoverConfig, param
func (_m *AsyncBR) StartBackup(dataMoverConfig map[string]string, param interface{}) error {
	ret := _m.Called(dataMoverConfig, param)
...
// StartRestore provides a mock function with given fields: snapshotID, dataMoverConfig
func (_m *AsyncBR) StartRestore(snapshotID string, dataMoverConfig map[string]string) error {
	ret := _m.Called(snapshotID, dataMoverConfig)
	...
	if rf, ok := ret.Get(0).(func(string, map[string]string) error); ok {
		r0 = rf(snapshotID, dataMoverConfig)
	} else {
		r0 = ret.Error(0)
	}
