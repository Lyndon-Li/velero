...
func (r *RestoreMicroService) cancelDataDownload(dd *velerov2alpha1api.DataDownload) {
	...
	r.eventRecorder.Event(dd, false, datapath.EventReasonCancelling, "Cancelling for data download %s", dd.Name)
